        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FirstName = table.Column<string>(type: "nvarchar(52)", maxLength: 52, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseInstances_Courses_CursusId",
                        column: x => x.CursusId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseInstanceStudent", x => new { x.CourseInstancesId, x.StudentsId });
                    table.ForeignKey(
                        name: "FK_CourseInstanceStudent_CourseInstances_CourseInstancesId",
                        column: x => x.CourseInstancesId,
                        principalTable: "CourseInstances",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseInstanceStudent_Students_StudentsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseInstances_CursusId_StartDate",
                table: "CourseInstances",
                columns: new[] { "CursusId", "StartDate" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CourseInstanceStudent_StudentsId",
